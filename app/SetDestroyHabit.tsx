...
export default function SetDestroyHabit() {
  ...
  const handleSaveHabit = async () => {
    ...
    const trimmedTries = Number(tries);
    ...
    console.log(!trimmedHabit);
    if (isNaN(Number(trimmedTries)) || Number(tries) < 0) {
      alert("Number of tries must not be empty or negative number.");
      return;
    }
    /*
    ...
    */
    ...
    try {
      await addHabit(trimmedHabit, trimmedGoal, reward.trim(), trimmedTries, times);
    ...
    <View style={styles.modalContainer}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps='handled'>
        <View style={styles.card}>
          ...
          <TextInput
            placeholder="e.g., Smoking, Drinking Alcohol"
            value={habit}
